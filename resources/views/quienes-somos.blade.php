...
@section('contenido')
    <style>
        /* Sobrescribimos la forma circular del CSS global para hacerlas cuadradas/rectangulares */
        .card-equipo .contenedor-img {
            padding: 0 !important; /* Quitamos los márgenes para que toque los bordes */
            display: block !important;
            border-bottom: 3px solid #FF3B3B !important; /* Acento Mars Red separando la foto del texto */
            border-radius: 15px 15px 0 0 !important; /* Solo redondea las puntas de arriba */
            overflow: hidden !important;
        }

        .card-equipo .contenedor-img img {
            border-radius: 0 !important; /* Quitamos el modo circular */
            width: 100% !important; /* Fuerza a ocupar todo el ancho de la tarjeta */
            height: 280px !important; /* Alto fijo para que todas se vean parejas */
            object-fit: cover !important;
            object-position: top center !important; /* Centra la foto en los rostros */
            border: none !important; /* Quitamos el borde rojo alrededor de la foto */
            box-shadow: none !important;
        }
        
        .card-equipo {
            overflow: hidden; /* Asegura que la imagen no se salga de las esquinas redondeadas de la tarjeta */
        }
    </style>
